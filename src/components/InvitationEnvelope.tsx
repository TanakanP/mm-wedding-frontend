...
export default function InvitationEnvelope({
  ...
  return (
    <div className="relative mx-auto h-[46vw] min-h-56 max-h-[335px] w-[min(88vw,610px)] [perspective:1200px]">
      ...
      <motion.div
        aria-hidden={!open}
        className="absolute inset-x-[8%] top-[9%] z-[2] h-[82%] rotate-[1.5deg] bg-cream p-2 pb-8 text-foreground shadow-[0_14px_30px_rgba(60,30,38,0.24)] md:p-3 md:pb-10"
      ...
      {seal === "button" ? (
        ...
        <motion.div
          className={sealClassName}
          initial={reduceMotion ? false : { opacity: 1, scale: 1, rotate: 0 }}
          animate={
            open
              ? { opacity: 0, scale: 0.55, rotate: -12 }
